...
var (
	// DefaultAllowedClients are "06-solomachine" and "07-tendermint" and "99-ostracon"
	DefaultAllowedClients = []string{exported.Solomachine, exported.Tendermint, exported.Ostracon}
